...
use crate::{BOOK_MAGIC, COMPACT_COVER_BYTE_LEN, COVER_BYTE_LEN, ParseError, VERSION};
...
impl<'a> Book<'a> {
    ...
    pub const fn author(&self) -> &'a str {
        self.author
    }
    ...
    pub const fn compact_cover(&self) -> &'a [u8] {
        self.compact_cover
    }
